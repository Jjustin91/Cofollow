                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <button v-if="$page.props.jetstream.managesProfilePhotos" class="flex items-center gap-2 text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-transparent transition pr-2">
                                            <!-- The Profile Photo -->
                                            <img class="h-8 w-8 rounded-full object-cover border border-gray-200" :src="$page.props.auth.user.profile_photo_url" :alt="$page.props.auth.user.name">
                                            
                                            <!-- The Name and Dropdown Arrow (Hidden on very small mobile screens) -->
